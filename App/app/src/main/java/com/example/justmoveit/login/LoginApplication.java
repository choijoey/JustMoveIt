...
public class LoginApplication extends Application {
    ...
    private static volatile LoginApplication instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return LoginApplication.getGlobalApplicationContext();
                }
            };
        }
    }

    public static LoginApplication getGlobalApplicationContext() {
        if(instance == null) {
